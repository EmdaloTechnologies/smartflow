...
#ifndef _APP_SIMCOM_H
#define _APP_SIMCOM_H
...
#include "config/sam_d51_xpro/system/console/sys_console.h"
...
typedef enum
{
    ...
    APP_SIMCOM_STATE_INIT=0,
    APP_SIMCOM_STATE_SERVICE_TASKS,
    /* TODO: Define states used by the application state machine. */
    APP_SIMCOM_STATE_SIM868_READY,
